...
export const userAUpdateReducer = (state = {}, action) => {
  switch (action.type) {
    case actions.USERA_UPDATE_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case actions.USERA_UPDATE_SUCCESS:
      return {
        ...state,
        loading: false,
        success: true,
      };
    case actions.USERA_UPDATE_FAIL:
      return {
        ...state,
        loading: false,
        error: action.payload,
...
export const userADetailsReducer = (state = {}, action) => {
  switch (action.type) {
    case actions.USERA_DETAILS_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case actions.USERA_DETAILS_SUCCESS:
      return {
        ...state,
        loading: false,
        user: action.payload,
      };
    case actions.USERA_DETAILS_FAIL:
      return {
        ...state,
        loading: false,
        error: action.payload,
...
export const userAUpdateProfileReducer = (state = {}, action) => {
  switch (action.type) {
    case actions.USERA_UPDATE_PROFILE_REQUEST:
      return {
        ...state,
        loading: true,
      };
    case actions.USERA_UPDATE_PROFILE_SUCCESS:
      return {
        ...state,
        loading: false,
        error: null,
    ...
    case actions.USERA_UPDATE_PROFILE_FAIL:
      return {
        ...state,
        loading: false,
        error: action.payload,
